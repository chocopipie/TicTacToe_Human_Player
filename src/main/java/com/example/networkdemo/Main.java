...
//                                        System.out.println("Player 2: " + roomJoined.getPlayer2().getUserName());
                                    ...
                                    case "ROOM_ADDED":
                                       ...
                                       // roomList.printList();
                                        ...
                                        SceneController sc = new SceneController(); //to make SceneController lobby function non-static
                                                                                    //will delete if this does nothing
                                        sc.updateLobby(list);
                                        break;
                                    default:
...
//    static ObjectOutputStream toServer = null;
////    private List<HumanPlayer> human=new ArrayList<HumanPlayer>();
//    private Vector<GameRoom> gameRoomList;   //Stores all gameRooms
//
//    @Override
//    public void start(Stage stage) throws IOException {
//
...
//
//                                        //update game channels in Lobby to display most current rooms
//                                        gameRoomList = (Vector<GameRoom>) message.getData();
////                                        SceneController.updateLobby(gameRoomList);
//
//                                        break;
//                                    case "JOIN_SUCCESS":
//                                        // get room created, the token
